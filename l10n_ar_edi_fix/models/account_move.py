...
class AccountMove(models.Model):
    ...
    def wsfe_get_cae_request(self, client=None):
        ...
        if res.get('MonId') != 'PES': # WSFE 10241
            ...
            res['FeDetReq'][0]['FECAEDetRequest']['CanMisMonExt'] = l10n_ar_payment_foreign_currency
    ...
    def l10n_ar_check_rate(self):
        ...
        if self.currency_id != self.company_currency_id and self.l10n_ar_payment_foreign_currency == "Yes":
